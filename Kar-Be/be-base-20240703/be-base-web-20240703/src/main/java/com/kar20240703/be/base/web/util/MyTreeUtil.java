...
import com.kar20240703.be.base.web.model.domain.BaseEntity;
import com.kar20240703.be.base.web.model.domain.BaseEntityTree;
...
public class MyTreeUtil {
    ...
    public static <T extends BaseEntityTree<T>> List<T> getFullTreeByDeepNode(Collection<T> deepNodeCollection,
        ...
        return getFullTreeByDeepNode(deepNodeCollection, allCollection, BaseConstant.TOP_PID);
    ...
    private static <T extends BaseEntityTree<T>> void doGetFullTree(Collection<T> deepNodeCollection,
        ...
        Set<Long> pidSet = deepNodeCollection.stream().map(BaseEntityTree::getPid).collect(Collectors.toSet());
    ...
    public static <T extends BaseEntityTree<T>> List<T> listToTree(Collection<T> collection) {
        ...
        return listToTree(collection, false, BaseConstant.TOP_PID);
    ...
    public static <T extends BaseEntityTree<T>> List<T> listToTree(Collection<T> collection, boolean childrenFlag) {
        ...
        return listToTree(collection, childrenFlag, BaseConstant.TOP_PID);
    ...
    public static <T extends BaseEntityTree<T>> Map<Long, Set<Long>> getIdAndDeepIdSetMap(Collection<T> collection,
        ...
        Map<Long, Set<Long>> groupParentIdMap = collection.stream().collect(
            Collectors.groupingBy(BaseEntityTree::getPid, Collectors.mapping(BaseEntity::getId, Collectors.toSet())));
