package com.kar20240703.be.base.web.configuration.base;
...
@Configuration
@ComponentScan(basePackages = "com.kar20240703.be.base")
@MapperScan(basePackages = "com.kar20240703.be.base.**.mapper")
@EnableAsync
@EnableScheduling
