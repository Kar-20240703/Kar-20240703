...
public class MyEntityUtil {
    ...
    public static Long getNotNullParentId(Long aLong) {
        return getNotNullLong(aLong, BaseConstant.TOP_PID);
    }
    ...
    public static void handleParentId(BaseEntityTree<?> baseEntityTree) {
        ...
        if (baseEntityTree != null && BaseConstant.TOP_PID.equals(baseEntityTree.getPid())) {
            baseEntityTree.setPid(null);
        }
    ...
    public static Long getNotNullLong(Long aLong) {
        return getNotNullLong(aLong, BaseConstant.NEGATIVE_ONE_LONG);
    }
