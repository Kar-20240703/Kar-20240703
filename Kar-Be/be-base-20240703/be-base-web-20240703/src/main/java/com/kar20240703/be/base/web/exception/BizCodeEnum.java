...
public enum BizCodeEnum {
    ...
    RESULT_OK(200, BizCodeEnum.OK), //
    RESULT_SEND_OK(200, BizCodeEnum.SEND_OK), //
    ...
    THIS_OPERATION_CANNOT_BE_PERFORMED_WITHOUT_BINDING_AN_EMAIL_ADDRESS(100171,
        "操作失败：您还没有绑定邮箱，无法进行该操作"), //
    THERE_IS_NO_BOUND_MOBILE_PHONE_NUMBER_SO_THIS_OPERATION_CANNOT_BE_PERFORMED(100181,
