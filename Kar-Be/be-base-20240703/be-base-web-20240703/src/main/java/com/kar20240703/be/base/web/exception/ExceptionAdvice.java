...
import com.kar20240703.be.base.web.util.MyEntityUtil;
import com.kar20240703.be.base.web.util.MyExceptionUtil;
...
public class ExceptionAdvice {
    ...
    public R<?> handleValidException(MethodArgumentNotValidException e) {
        ...
        try {
            ...
            R.error(BizCodeEnum.PARAMETER_CHECK_ERROR, map); // 这里肯定会抛出 BaseException异常
    ...
    public R<?> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        ...
        try {
            ...
            R.error(BizCodeEnum.PARAMETER_CHECK_ERROR, e.getMessage()); // 这里肯定会抛出 BaseException异常
    ...
    public R<?> handleAccessDeniedException(AccessDeniedException e) {
        ...
        try {
            ...
            R.error(BizCodeEnum.INSUFFICIENT_PERMISSIONS); // 这里肯定会抛出 BaseException异常
    ...
    private R<?> getBaseExceptionApiResult(BaseException e) {
