...
public enum AuthRequestCategoryEnum {
    ...
    private static final Map<Integer, AuthRequestCategoryEnum> MAP =
        new HashMap<>(AuthRequestCategoryEnum.values().length);

    static {

        for (AuthRequestCategoryEnum item : AuthRequestCategoryEnum.values()) {
    ...
    @NotNull
    public static AuthRequestCategoryEnum getByCode(@Nullable Integer code) {
