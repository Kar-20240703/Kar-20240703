...
public class RequestUtil {
     ...
     */
    @NotNull
    public static AuthRequestCategoryEnum getRequestCategoryEnum() {
     ...
     */
    @NotNull
    public static AuthRequestCategoryEnum getRequestCategoryEnum(@Nullable HttpServletRequest httpServletRequest) {

        if (httpServletRequest == null) {
            return AuthRequestCategoryEnum.PC_BROWSER_WINDOWS;
        }

        return AuthRequestCategoryEnum.getByCode(
