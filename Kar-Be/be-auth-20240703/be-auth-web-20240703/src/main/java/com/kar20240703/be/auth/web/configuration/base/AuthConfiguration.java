package com.kar20240703.be.auth.web.configuration.base;
...
public class AuthConfiguration {
    ...
    public AuthConfiguration(@Value("${spring.application.name:applicationName}") String applicationName,
        @Value("${server.port:8080}") int port, @Value("${spring.profiles.active:prod}") String profilesActive) {

        AuthConfiguration.applicationName = applicationName;
        AuthConfiguration.port = port;
        AuthConfiguration.profilesActive = profilesActive;
    ...
    public static boolean prodFlag() {
        ...
        return "prod".equals(AuthConfiguration.profilesActive);
    ...
    public static boolean devFlag() {
        ...
        return "dev".equals(AuthConfiguration.profilesActive);
