...
import com.kar20240703.be.temp.web.filter.JwtAuthorizationFilter;
...
public class SecurityConfiguration {
    ...
    /**
     * @param tempConfiguration 不要删除，目的：让 springboot实例化该对象
     */
    @SneakyThrows
    @Bean
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, TempConfiguration tempConfiguration,
