package com.kar20240703.be.temp.web.model.constant;

/**
 * 正则表达式的常量类
 */
public interface TempRegexConstant {
    ...
    String USER_NAME_REGEXP = "^[\\u4E00-\\u9FA5A-Za-z0-9_-]{2,20}$"; // 用户名限制：只能包含中文，数字，字母，下划线，横杠，长度2-20
