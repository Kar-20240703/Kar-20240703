...
public enum TempRequestCategoryEnum {
    ...
    private static final Map<Integer, TempRequestCategoryEnum> MAP =
        new HashMap<>(TempRequestCategoryEnum.values().length);

    static {

        for (TempRequestCategoryEnum item : TempRequestCategoryEnum.values()) {
    ...
    @NotNull
    public static TempRequestCategoryEnum getByCode(@Nullable Integer code) {
