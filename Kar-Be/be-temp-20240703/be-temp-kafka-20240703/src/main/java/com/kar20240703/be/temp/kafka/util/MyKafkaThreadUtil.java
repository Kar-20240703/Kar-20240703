...
public class MyKafkaThreadUtil {
    ...
    public static void execute(VoidFunc0 voidFunc0) {
        ...
        taskExecutor.execute(() -> MyTryUtil.tryCatch(voidFunc0));
    ...
    public static void execute(VoidFunc0 voidFunc0, @Nullable CountDownLatch countDownLatch,
        ...
        execute(() -> {
            ...
            MyTryUtil.tryCatchFinally(voidFunc0, exceptionVoidFunc1, () -> {
                ...
                MyTryUtil.execVoidFunc0(finallyVoidFunc0);
    ...
    public static ScheduledFuture<?> schedule(VoidFunc0 voidFunc0, Trigger trigger) {
        ...
        return taskScheduler.schedule(() -> MyTryUtil.tryCatch(voidFunc0), trigger);

    }

    /**
     * 提交任务调度请求 注意任务只执行一次，使用 startTime指定其启动时间
     *
     * @param voidFunc0 待执行任务
    ...
    public static ScheduledFuture<?> schedule(VoidFunc0 voidFunc0, Instant startTime) {
        ...
        return taskScheduler.schedule(() -> MyTryUtil.tryCatch(voidFunc0), startTime);
    ...
    /**
     * 使用 fixedRate的方式提交任务调度请求 任务首次启动时间由传入参数指定
     *
    ...
    public static ScheduledFuture<?> scheduleAtFixedRate(VoidFunc0 voidFunc0, Date startTime, long period) {
        ...
        return taskScheduler.scheduleAtFixedRate(() -> MyTryUtil.tryCatch(voidFunc0), startTime, period);
    ...
    public static ScheduledFuture<?> scheduleAtFixedRate(VoidFunc0 voidFunc0, long period) {
        ...
        return taskScheduler.scheduleAtFixedRate(() -> MyTryUtil.tryCatch(voidFunc0), period);

    }

    /**
     * 使用 fixedDelay的方式提交任务调度请求 任务首次启动时间由传入参数指定
     *
     * @param voidFunc0 待执行的任务
     * @param startTime 任务启动时间
     * @param period    两次任务启动时间之间的间隔时间，默认单位是毫秒
    ...
    public static ScheduledFuture<?> scheduleWithFixedDelay(VoidFunc0 voidFunc0, Date startTime, long period) {
        ...
        return taskScheduler.scheduleWithFixedDelay(() -> MyTryUtil.tryCatch(voidFunc0), startTime, period);
    ...
    public static ScheduledFuture<?> scheduleWithFixedDelay(VoidFunc0 voidFunc0, long period) {
        ...
        return taskScheduler.scheduleWithFixedDelay(() -> MyTryUtil.tryCatch(voidFunc0), period);
